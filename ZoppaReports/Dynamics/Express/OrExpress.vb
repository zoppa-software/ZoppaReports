    ...
    Public NotInheritable Class OrExpress
        ...
        Public Sub New(tml As IExpression, tmr As IExpression)
            If tml IsNot Nothing AndAlso tmr IsNot Nothing Then
                ...
                Me.mTmr = tmr
            Else
                Throw New ReportsAnalysisException("論理和式の生成にNullは使用できません")
            End If
        End Sub
        ...
        Public Function Executes(env As Environments) As IToken Implements IExpression.Executes
            ...
            If TypeOf tml.Contents Is Boolean AndAlso TypeOf tmr.Contents Is Boolean Then
                ...
                Catch ex As Exception
                    Throw New ReportsAnalysisException($"論理和ができません。{tml.Contents} or {tmr.Contents}", ex)
                End Try
            Else
                Throw New ReportsAnalysisException($"論理和ができません。{tml.Contents} or {tmr.Contents}")
            End If
        End Function
